      ...
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-5 sm:px-8">
        ...
        <div className="flex items-center gap-5">
          <nav className="hidden items-center gap-4 text-sm font-medium text-zinc-700 md:flex">
            {navigationLinks.map((item) => (
              <Link
                ...
                className={
                  item.highlighted
                    ? "rounded-md bg-zinc-200 px-3 py-1.5 text-zinc-900"
          ...
          <div className="flex items-center gap-2">
            <Link
              href="#"
              className="rounded-lg border border-zinc-300 bg-zinc-100 px-3 py-1.5 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-200"
            >
              Sign in
            </Link>
            <Link
              href="#"
              className="rounded-lg bg-zinc-900 px-3 py-1.5 text-sm font-medium text-zinc-50 transition-colors hover:bg-zinc-700"
            >
              Register
            </Link>
          </div>
