...
[ApiController]
public sealed class ActorBreakdownController(IActorBreakdownService service) : ControllerBase
{
    [HttpGet("actor-breakdown")]
    public async Task<IActionResult> GetActorBreakdownAsync(
        ...
        CancellationToken ct)
    {
        ...
        var res = await service.GetActorBreakdownAsync(filter, ct);
